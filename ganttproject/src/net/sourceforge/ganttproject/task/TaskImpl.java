...
public class TaskImpl implements Task {
    ...
    @Override
    public List<HumanResource> getAssignedHumanResources() {
        ResourceAssignment[] assignments = myAssignments.getAssignments();
        List<HumanResource> toReturn = new LinkedList<>();
        for (int i = 0; i < assignments.length; i++) {
            HumanResource humanResource = assignments[i].getResource();
            toReturn.add(humanResource);
        }
        return toReturn;
    }
