...
public class PertChartAbstraction {
    ...
    /**
     * @param task The task from which we want the <code>TaskGraphNode</code>
    ...
    static class TaskGraphNode {
        ...
        /**
         * Retorna lista com as pessoas que estao atribuidas à tarefa
         *
         * @return - retorna lista com as pessoas que estao atribuidas à tarefa
         */
        List<HumanResource> getAllHumanResources() {
            return myTask.getAssignedHumanResources();
        }
